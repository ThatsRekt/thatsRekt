 ...
 */
/**
 * The live interactive vote buttons. This module is lazily imported by
 * ConfirmVoteButtons.tsx — it lives in the wagmi async chunk, not the
 * homepage-critical bundle. All wagmi hooks (useAccount, useIsWhitelisted,
 * useUserVote, useConfirmPost) are called here, inside WagmiProvider.
 */
export function ConfirmVoteButtonsLive({
  chainId,
  postId,
  upCount,
  downCount,
