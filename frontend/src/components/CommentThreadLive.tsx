...
/**
 * Full interactive comment thread: fetches comments, shows the compose
 * box with wagmi-signed submissions, edit/delete per own comment.
 *
 * This module is lazily imported by CommentThread.tsx so all wagmi
 * hook imports (useAccount, useIsWhitelisted, useSubmitComment,
 * useEditComment, useDeleteComment) remain in the wagmi async chunk,
 * not the homepage-critical bundle.
 *
 * Mounted from `PostDetail` after the rest of the post body.
 */
