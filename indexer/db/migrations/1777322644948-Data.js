module.exports = class Data1777322644948 {
    ...
    async up(db) {
        ...
        await db.query(`ALTER TABLE "vote" ADD CONSTRAINT "FK_b7f5b42bfe9b12e0cf1de3290e4" FOREIGN KEY ("post_id") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "vote" ADD CONSTRAINT "FK_f5c90d8438424ec0f044ef945a9" FOREIGN KEY ("voter_id") REFERENCES "whitelister"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`ALTER TABLE "vote" DROP CONSTRAINT "FK_b7f5b42bfe9b12e0cf1de3290e4"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_f5c90d8438424ec0f044ef945a"`)
        await db.query(`DROP INDEX "public"."IDX_b7f5b42bfe9b12e0cf1de3290e"`)
