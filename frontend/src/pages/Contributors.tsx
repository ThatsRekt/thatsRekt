...
/**
 * Whitelisted poster directory, per chain. The leaderboard that used
 * to live on this page now has its own route at `/leaderboard`. The
 * upcoming nav rework will fold this page's contents into a unified
 * `/about` page; for now the route stays so existing links don't 404.
 */
